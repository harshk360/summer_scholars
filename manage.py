...
from taskmanager.database import db
from taskmanager.settings import DevConfig, ProdConfig
from taskmanager.user.models import User

CONFIG = ProdConfig if os.environ.get('TASKMANAGER_ENV') == 'prod' else DevConfig
